...
def combine_weights(citation_weights, text_weights, cpc_weights):
    ...
    for row in citation_weights:
        ...
        weight = row['weight']
        all_weights[(f1, f2)] = {'weight_citation': weight, 'weight_text': 0, 'weight_cpc': 0}
    ...
    for row in text_weights:
        ...
        try:
            ...
            all_weights[(f1, f2)] = {'weight_citation': 0, 'weight_text': weight, 'weight_cpc': 0}
    ...
    for row in cpc_weights:
        ...
        try:
            ...
            all_weights[(f1, f2)] = {'weight_citation': 0, 'weight_text': 0, 'weight_cpc': weight}
    return all_weights
...
def scale_weights(all_weights):
    ...
    for k in all_weights.keys():
        ...
        sts_weight = alpha * citation_weight + beta * text_weight + (1 - alpha - beta) * cpc_weight
        hybrid_sts_scaled_weights.append({'family_id': family_id, 'family_link': family_link, 'weight': sts_weight})
