...
CREATE OR REPLACE TABLE patent_clustering_metrics.patent_assignment_level_by_cpc_weights AS (
  ...
  new_within_cluster_links AS (
    SELECT
      staging_patent_clusters.cpc_weights.family_id AS family_id,
      staging_patent_clusters.cpc_weights.family_reference AS ref_id,
    ...
    LEFT JOIN
      patent_cluster_experiments.patent_cluster_intial_experiement_sts_scaling_20240726_best_clusters_mapped AS c1 ON
        staging_patent_clusters.cpc_weights.family_id = c1.family_id
    LEFT JOIN
      patent_cluster_experiments.patent_cluster_intial_experiement_sts_scaling_20240726_best_clusters_mapped AS c2 ON
        staging_patent_clusters.cpc_weights.family_reference = c2.family_id
