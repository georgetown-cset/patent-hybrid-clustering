...
class TestCpcDescriptions(unittest.TestCase):
    ...
    def test_combine_xml_titles(self):
        code_titles = {("A", 2): "HUMAN NECESSITIES", ("A01", 3): "AGRICULTURE", ("A21", 3): "FOODSTUFFS; TOBACCO",
                       ("B", 2): "PERFORMING OPERATIONS", ("B01", 3): "SEPARATING; MIXING", ("B21", 3): "SHAPING",
                       ("A01", 4): "AGRICULTURE; FORESTRY; ANIMAL HUSBANDRY; HUNTING; TRAPPING; FISHING",
                       ("A21", 4): "BAKING; EDIBLE DOUGH",
                       ("B01", 4): "PHYSICAL OR CHEMICAL PROCESSES OR APPARATUS IN GENERAL",
                       ("B21", 4): "MECHANICAL METAL-WORKING WITHOUT ESSENTIALLY REMOVING MATERIAL; PUNCHING METAL",
                       ...
                       ("A01C", 5): "PLANTING; SOWING; FERTILISING", ("A01D", 5): "HARVESTING; MOWING",
                       ("B01B", 5): "BOILING; BOILING APPARATUS", ("B01D", 5): "SEPARATION",
        ...
        final_text = cpc_descriptions.setup_combine_xml_titles(hierarchy, code_titles, initial_levels)
        all_cpcs = set()
        for row in final_text:
            ...
            self.assertTrue(final_text[row]["text"].startswith(code_titles[(final_text[row]["code"][0], 2)]))
