...
[sql/initial_map](archive/sql/initial_map): SQL scripts used to build or evaluate the original map or analyze raw patent data in preparation for its creation.

[sql/metrics](archive/sql/metrics): Old sql scripts used for extracting evaluation metrics during development.
